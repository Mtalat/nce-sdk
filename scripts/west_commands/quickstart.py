...
class QuickStart(WestCommand):
    ...
    def __init__(self):
        super().__init__(
            ...
            dedent(''' Build and flash CoAP (With  DTLS) or UDP Demos, the payload reduction (using 1NCE Energy saver) can also be enabled.
            '''))
    ...
    def do_add_parser(self, parser_adder):
        ...
        parser.add_argument('-p', '--protocol', help='Select the protocol: coap (Default) or udp')
    ...
    def do_run(self, args, unknown_args):
        ...
        if (args.protocol is None or (args.protocol is not None and args.protocol.lower() == "coap") ):
            ...
            if(  (args.energysaving is not None and args.energysaving.lower() == "y") ):
                ...
                log.inf('1NCE Energy Saver is Enabled', args.protocol)
